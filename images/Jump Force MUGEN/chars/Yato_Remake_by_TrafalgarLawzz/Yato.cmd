...
trigger6 = stateno = 405 && Helper(450), Movecontact
trigger7 = stateno = 405 && Helper(461), Movecontact
;===========================================================================
;SPECIALS:
;===========================================================================
; Sword Rush
...
[State -1, Yukine - Slash Proyection]
type = ChangeState
triggerall = p2bodydist x != [-60,60]
Triggerall = power >= 1000
value = 1200
